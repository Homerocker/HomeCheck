...
function HomeCheck:UnitHasAbility(playerName, spellID)
    return not self.spells[self.spells[spellID].parent or spellID].talentTab or not self.spells[self.spells[spellID].parent or spellID].talentIndex or self.LibGroupTalents:UnitHasTalent(playerName, (GetSpellInfo(spellID)))
end
